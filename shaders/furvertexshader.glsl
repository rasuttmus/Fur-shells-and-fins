...
void main() {
    ...
    // Forces that makes the fur move
    ...
    vec3 surfaceAdvection = vec3(vec4(vertexPosition, 1.0)) + vertexNormal * layerOffset;
    ...
    // This is used to evaluate the worley noise function
    UV3D = vertexPosition * furPatternScale;
